...
### Ändringslogg
- **v3.11** — Ny ⚙️ Inställningar-sektion med Kontokonfiguration (add/edit/delete Avanza-konton från UI), Kategori-editor (ersätter prompt()-dialoger med visuellt inline-formulär), Strategiparametrar (MA200-gränser, nödutgång, ombalansering, konc.risk), Profil & information, Värdepappersfilter (exkludera VP/konton vid import) och Export/import av inställningar som JSON. Kassa-tabellen visar nu alla konton med inline-inmatning per rad.
