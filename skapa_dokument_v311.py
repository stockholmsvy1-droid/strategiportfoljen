"""
Skapar Strategiportfoljen_Beskrivning_v311.docx
- Baserad på v310, versionssträngar uppdaterade
- Ny avslutningssida: Nyheter i version 3.11
"""
...
dst = fr"{DIR}\Strategiportfoljen_Beskrivning_v311.docx"
IMG = fr"{DIR}\titelbild_v311.png"
...
for para in new_doc.paragraphs:
    for run in para.runs:
        for old, new in [("v3.10","v3.11"),("v310","v311"),
    ...
    for row in tbl.rows:
        for cell in row.cells:
            for para in cell.paragraphs:
                for run in para.runs:
                    if "3.10" in run.text:
                        run.text = run.text.replace("3.10","3.11")
...
sidbyte(new_doc)
rubrik1(new_doc, "10. Nyheter i version 3.11")
rubrik2(new_doc, "Inställningar-sektion och förbättrad Kassa")
brödtext(new_doc,
    "Version 3.11 introducerar en komplett administrationsfunktion via en ny ⚙️ Inställningar-sektion "
...
r = p.add_run("Strategiportföljen v3.11  ·  Byggt för Martin  ·  Strategi från januari 2026")
