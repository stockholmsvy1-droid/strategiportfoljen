"""
Skapar Testprotokoll_Strategiportfoljen_v313.xlsx
Täcker alla funktioner i v3.13 — används av Martin för manuell verifiering.
"""
...
cell(ws0,2,2,"Testprotokoll — Strategiportföljen v3.13", NAVY, hfont(14), C)
...
cell(ws0,11+len(sviter),3,"v3.13",ROW_WHITE,bfont(),L)
...
# T3: uppdaterad för v313 (inline-inmatning, sparkonto som separat rad)
svit("T3 – Kassa och Avstämning", "T3", "Kassa & Avstämning (v3.13)",
...
svit("T10 – Inställningar", "T10", "Inställningar-sektionen (ny i v3.13)",
...
dst = r"C:\Users\hejma\Projekt_Claude\strategiportfoljen\Testprotokoll_Strategiportfoljen_v313.xlsx"
wb.save(dst)
print(f"Skapad: {dst}")
