"""
Skapar titelbild_v312.png — vit bakgrund, blå kurva som matchar app-ikonen,
...
draw.text((PAD, 142), "Personlig portföljapp — version 3.12", font=f_sub, fill=(75, 85, 99))
...
img.save(r"C:\Users\hejma\Projekt_Claude\strategiportfoljen\titelbild_v312.png",
         "PNG", dpi=(150, 150))
print("Skapad: titelbild_v312.png")
