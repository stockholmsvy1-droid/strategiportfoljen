"""
Skapar Testprotokoll_Strategiportfoljen_v312.xlsx
Täcker alla funktioner i v3.12 — används av Martin för manuell verifiering.
"""
...
cell(ws0,2,2,"Testprotokoll — Strategiportföljen v3.12", NAVY, hfont(14), C)
...
cell(ws0,11+len(sviter),3,"v3.12",ROW_WHITE,bfont(),L)
...
# T3: uppdaterad för v312 (inline-inmatning, sparkonto som separat rad)
svit("T3 – Kassa och Avstämning", "T3", "Kassa & Avstämning (v3.12)",
...
svit("T10 – Inställningar", "T10", "Inställningar-sektionen (ny i v3.12)",
...
dst = r"C:\Users\hejma\Projekt_Claude\strategiportfoljen\Testprotokoll_Strategiportfoljen_v312.xlsx"
wb.save(dst)
print(f"Skapad: {dst}")
